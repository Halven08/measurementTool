function patientData = importPatientData(filename, startRow, endRow)


patientData=struct('Name', [],...
                 'Surname', [],...
                 'Code', []);
...
patientData.Name = raw(:,1);
patientData.Surname = raw(:,2);
patientData.Code = raw(:,3);
